...
@Testcontainers
public class ClickHouseDebeziumEmbeddedPostgreSQLDecoderBufsIT {
    ...
    public void testDataTypesDB() throws Exception {
        ...
        defaultProps.setProperty("plugin.name", "decoderbufs");
        ...
        defaultProps.setProperty("schema.evolution", "true");
