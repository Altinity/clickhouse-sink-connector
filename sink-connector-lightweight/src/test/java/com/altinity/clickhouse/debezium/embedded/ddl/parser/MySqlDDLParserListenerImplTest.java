...
//    }
    ...
    public void testAlterTableColumnWithComment() {
        ...
        Assert.assertTrue("ALTER TABLE employees.test_table ADD COLUMN col1 Nullable(String)".equalsIgnoreCase(clickHouseQuery.toString()));
    }
    ...
    public void testAlterTableColumnWithCommentAndDecimalScale() {
        ...
        Assert.assertTrue("ALTER TABLE employees.test_table ADD COLUMN col1 Nullable(Decimal(10,2))".equalsIgnoreCase(clickHouseQuery.toString()));
    }
    ...
    public void testGhostSQL() {
        ...
        Assert.assertTrue("CREATE TABLE employees.`_j_failed_s_g`(id Nullable(Int32),`_version` UInt64,`is_deleted` UInt8) Engine=ReplacingMergeTree(_version,is_deleted) ORDER BY id".equalsIgnoreCase(clickHouseQuery2.toString()));
    }
    ...
    public void testCreateDefiner() {
        ...
        Assert.assertTrue("".equalsIgnoreCase(clickHouseQuery.toString()));
    }
