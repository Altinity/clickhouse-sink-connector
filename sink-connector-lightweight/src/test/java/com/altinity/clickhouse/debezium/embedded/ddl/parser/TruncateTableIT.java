...
public class TruncateTableIT {
     ...
     * inserted afterwards.
     */
    // DESTRUCTIVE: issues a TRUNCATE, but only against this test's own
    // throwaway `truncate_then_insert` table inside a disposable
    // testcontainers MySQL/ClickHouse pair. Nothing outside the container
    // exists to be destroyed.
    @Test
    ...
    public void testRowsInsertedAfterTruncateSurvive() throws Exception {
        ...
        // DESTRUCTIVE: empties `truncate_then_insert`, a table this test
        // created in a disposable testcontainers MySQL instance.
        ...
        // DESTRUCTIVE: assertions only -- these read the throwaway container
        // table to prove the truncate landed at the right binlog position.
        // They destroy nothing themselves.
