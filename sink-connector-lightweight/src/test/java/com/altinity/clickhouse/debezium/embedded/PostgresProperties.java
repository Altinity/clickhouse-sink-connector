...
public class PostgresProperties {
    ...
    public static Properties getDefaultProperties(PostgreSQLContainer postgreSQLContainer, ClickHouseContainer clickHouseContainer) throws Exception {
        ...
        // far outside the Decimal128 range. Saturation is the product default
        // (clamp.out.of.range=true, spec 07.03 section 3.3); it is stated here
        // explicitly so the fixture's dependence on it stays visible. Under
        // clamp.out.of.range=false that row throws
        // DebeziumConverter.ValueOutOfRangeException in the writer, which is
        // terminal for the batch (spec 10.01 section 3.1) and stops the
        // engine; that path is pinned by DebeziumConverterRangePolicyTest and
        // PreparedStatementFieldMapperOutOfRangeTest.
