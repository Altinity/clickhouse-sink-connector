...
public class BinLogHistoryTest {
    ...
    public void testCreateHistoryTableSyntax() {
        ...
        // Union of BOTH sides of the merge: the generator now emits the
        // backtick-quoted database identifier (develop, so a database name that
        // needs quoting cannot break the DDL) AND the trailing `db_time`
        // MATERIALIZED column (2.10.0, Altinity #1283). Asserting either side
        // alone would silently drop the other side's fix.
    ...
    public void testCreateHistoryTableSyntaxWithDifferentNames() {
        ...
        // Union of BOTH sides of the merge — see the note in
        // testCreateHistoryTableSyntax: backtick-quoted database identifier
        // (develop) AND the trailing `db_time` MATERIALIZED column (2.10.0).
