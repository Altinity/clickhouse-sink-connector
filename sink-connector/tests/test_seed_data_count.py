...
class MyTestCase(unittest.TestCase):
    ...
    def test_seed_data_count(self):
        ...
        ch_employees_count = clickhouse_conn.execute_sql(
            "select count(*) from employees"
        )
        mysql_employees_count = mysql_conn.execute_sql(
            "select count(*) from employees_predated"
        )

        ch_customers_count = clickhouse_conn.execute_sql(
