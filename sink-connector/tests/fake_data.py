...
class FakeData:
    ...
    @classmethod
    def get_fake_employees_row_with_out_of_range_datetime(
        cls, primary_num, start_date, end_date
    ):
        fake = Faker()
    ...
    def get_fake_products_row(cls):
        ...
        row = (
            ...
            fake.company()[:10],
            fake.company()[:10],
            fake.unique.pyint(0, 100),
            fake.pyfloat(min_value=0, max_value=1),
            fake.pyfloat(min_value=0, max_value=2),
        )
