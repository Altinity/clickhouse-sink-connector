...
CREATE TABLE `binary_types_BINARY` (
  ...
  `Null Value` binary(1) DEFAULT NULL,
  PRIMARY KEY (`Type`)
...
CREATE TABLE `binary_types_VARBINARY5` (
  ...
  `Null Value` varbinary(5) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BIGINT` (
  `Type` varchar(50) NOT NULL,
  `Storage (Bytes)` int NOT NULL,
  `Minimum Value Signed` bigint NOT NULL,
  `Minimum Value Unsigned` bigint unsigned NOT NULL,
  `Maximum Value Signed` bigint NOT NULL,
  `Maximum Value Unsigned` bigint unsigned NOT NULL,
  `Null value Signed` bigint DEFAULT NULL,
  `Null value Unsigned` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BIT` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` bit(1) NOT NULL,
  `Maximum Value` bit(1) NOT NULL,
  `Null value` bit(1) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BIT2` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` bit(2) NOT NULL,
  `Maximum Value` bit(2) NOT NULL,
  `Null value` bit(2) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BIT4` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` bit(4) NOT NULL,
  `Maximum Value` bit(4) NOT NULL,
  `Null value` bit(4) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BIT64` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` bit(64) NOT NULL,
  `Maximum Value` bit(64) NOT NULL,
  `Null value` bit(64) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_BOOL` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` tinyint(1) NOT NULL,
  `Maximum Value` tinyint(1) NOT NULL,
  `Null value` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_INT` (
  `Type` varchar(50) NOT NULL,
  `Storage (Bytes)` int NOT NULL,
  `Minimum Value Signed` int NOT NULL,
  `Minimum Value Unsigned` int unsigned NOT NULL,
  `Maximum Value Signed` int NOT NULL,
  `Maximum Value Unsigned` int unsigned NOT NULL,
  `Null value Signed` int DEFAULT NULL,
  `Null value Unsigned` int unsigned DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_MEDIUMINT` (
  `Type` varchar(50) NOT NULL,
  `Storage (Bytes)` int NOT NULL,
  `Minimum Value Signed` mediumint NOT NULL,
  `Minimum Value Unsigned` mediumint unsigned NOT NULL,
  `Maximum Value Signed` mediumint NOT NULL,
  `Maximum Value Unsigned` mediumint unsigned NOT NULL,
  `Null value Signed` mediumint DEFAULT NULL,
  `Null value Unsigned` mediumint unsigned DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_SMALLINT` (
  `Type` varchar(50) NOT NULL,
  `Storage (Bytes)` int NOT NULL,
  `Minimum Value Signed` smallint NOT NULL,
  `Minimum Value Unsigned` smallint unsigned NOT NULL,
  `Maximum Value Signed` smallint NOT NULL,
  `Maximum Value Unsigned` smallint unsigned NOT NULL,
  `Null value Signed` smallint DEFAULT NULL,
  `Null value Unsigned` smallint unsigned DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `integer_types_TINYINT` (
  `Type` varchar(50) NOT NULL,
  `Storage (Bytes)` int NOT NULL,
  `Minimum Value Signed` tinyint NOT NULL,
  `Minimum Value Unsigned` tinyint unsigned NOT NULL,
  `Maximum Value Signed` tinyint NOT NULL,
  `Maximum Value Unsigned` tinyint unsigned NOT NULL,
  `Null value Signed` tinyint DEFAULT NULL,
  `Null value Unsigned` tinyint unsigned DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DECIMAL_10_0` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` decimal(10,0) NOT NULL,
  `Zero Value` decimal(10,0) NOT NULL,
  `Maximum Value` decimal(10,0) NOT NULL,
  `Null Value` decimal(10,0) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DECIMAL_1_0` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` decimal(1,0) NOT NULL,
  `Zero Value` decimal(1,0) NOT NULL,
  `Maximum Value` decimal(1,0) NOT NULL,
  `Null Value` decimal(1,0) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DECIMAL_40_20` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` decimal(40,20) NOT NULL,
  `Zero Value` decimal(40,20) NOT NULL,
  `Maximum Value` decimal(40,20) NOT NULL,
  `Null Value` decimal(40,20) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DECIMAL_65_0` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` decimal(65,0) NOT NULL,
  `Zero Value` decimal(65,0) NOT NULL,
  `Maximum Value` decimal(65,0) NOT NULL,
  `Null Value` decimal(65,0) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DECIMAL_65_30` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` decimal(65,30) NOT NULL,
  `Zero Value` decimal(65,30) NOT NULL,
  `Maximum Value` decimal(65,30) NOT NULL,
  `Null Value` decimal(65,30) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_DOUBLE` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` double NOT NULL,
  `Zero Value` double NOT NULL,
  `Maximum Value` double NOT NULL,
  `Null Value` double DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `numeric_types_FLOAT` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` float NOT NULL,
  `Zero Value` float NOT NULL,
  `Maximum Value` float NOT NULL,
  `Null Value` float DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `string_types_CHAR20_gbk` (
  ...
  `Empty Value` char(20) NOT NULL,
  `Space Value` char(20) NOT NULL,
  `Null Value` char(20) DEFAULT NULL,
  PRIMARY KEY (`Type`)
...
CREATE TABLE `string_types_LONGTEXT_gbk` (
  ...
  `Empty Value` longtext NOT NULL,
  `Space Value` longtext NOT NULL,
  `Null Value` longtext,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `string_types_MEDIUMTEXT_gbk` (
  ...
  `Empty Value` mediumtext NOT NULL,
  `Space Value` mediumtext NOT NULL,
  `Null Value` mediumtext,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `string_types_TEXT_gbk` (
  `Type` varchar(50) NOT NULL,
  `Value` text NOT NULL,
  `Empty Value` text NOT NULL,
  `Space Value` text NOT NULL,
  `Null Value` text,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `string_types_TINYTEXT_gbk` (
  ...
  `Empty Value` tinytext NOT NULL,
  `Space Value` tinytext NOT NULL,
  `Null Value` tinytext,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `string_types_VARCHAR20_gbk` (
  ...
  `Empty Value` varchar(20) NOT NULL,
  `Space Value` varchar(20) NOT NULL,
  `Null Value` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_DATE` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` date NOT NULL,
  `Mid Value` date NOT NULL,
  `Maximum Value` date NOT NULL,
  `Null Value` date DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_DATETIME` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime NOT NULL,
  `Mid Value` datetime NOT NULL,
  `Maximum Value` datetime NOT NULL,
  `Null Value` datetime DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_DATETIME1` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(1) NOT NULL,
  `Mid Value` datetime(1) NOT NULL,
  `Maximum Value` datetime(1) NOT NULL,
  `Null Value` datetime(1) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME1` VALUES ('DATETIME(1)','1000-01-01 00:00:00.0','2022-09-29 01:48:25.0','9999-12-31 23:59:59.9',NULL);
...
CREATE TABLE `temporal_types_DATETIME2` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(2) NOT NULL,
  `Mid Value` datetime(2) NOT NULL,
  `Maximum Value` datetime(2) NOT NULL,
  `Null Value` datetime(2) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME2` VALUES ('DATETIME(2)','1000-01-01 00:00:00.00','2022-09-29 01:49:05.00','9999-12-31 23:59:59.99',NULL);
...
CREATE TABLE `temporal_types_DATETIME3` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(3) NOT NULL,
  `Mid Value` datetime(3) NOT NULL,
  `Maximum Value` datetime(3) NOT NULL,
  `Null Value` datetime(3) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME3` VALUES ('DATETIME(3)','1000-01-01 00:00:00.000','2022-09-29 01:49:22.000','9999-12-31 23:59:59.999',NULL);
...
CREATE TABLE `temporal_types_DATETIME4` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(4) NOT NULL,
  `Mid Value` datetime(4) NOT NULL,
  `Maximum Value` datetime(4) NOT NULL,
  `Null Value` datetime(4) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME4` VALUES ('DATETIME(4)','1000-01-01 00:00:00.0000','2022-09-29 01:50:12.0000','9999-12-31 23:59:59.9999',NULL);
...
CREATE TABLE `temporal_types_DATETIME5` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(5) NOT NULL,
  `Mid Value` datetime(5) NOT NULL,
  `Maximum Value` datetime(5) NOT NULL,
  `Null Value` datetime(5) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME5` VALUES ('DATETIME(5)','1000-01-01 00:00:00.00000','2022-09-29 01:50:28.00000','9999-12-31 23:59:59.99999',NULL);
...
CREATE TABLE `temporal_types_DATETIME6` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` datetime(6) NOT NULL,
  `Mid Value` datetime(6) NOT NULL,
  `Maximum Value` datetime(6) NOT NULL,
  `Null Value` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_DATETIME6` VALUES ('DATETIME(6)','1000-01-01 00:00:00.000000','2022-09-29 01:50:56.918070','9999-12-31 23:59:59.999999',NULL);
...
CREATE TABLE `temporal_types_TIME` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time NOT NULL,
  `Mid Value` time NOT NULL,
  `Maximum Value` time NOT NULL,
  `Null Value` time DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME1` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(1) NOT NULL,
  `Mid Value` time(1) NOT NULL,
  `Maximum Value` time(1) NOT NULL,
  `Null Value` time(1) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME2` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(2) NOT NULL,
  `Mid Value` time(2) NOT NULL,
  `Maximum Value` time(2) NOT NULL,
  `Null Value` time(2) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME3` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(3) NOT NULL,
  `Mid Value` time(3) NOT NULL,
  `Maximum Value` time(3) NOT NULL,
  `Null Value` time(3) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME4` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(4) NOT NULL,
  `Mid Value` time(4) NOT NULL,
  `Maximum Value` time(4) NOT NULL,
  `Null Value` time(4) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME5` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(5) NOT NULL,
  `Mid Value` time(5) NOT NULL,
  `Maximum Value` time(5) NOT NULL,
  `Null Value` time(5) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIME6` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` time(6) NOT NULL,
  `Mid Value` time(6) NOT NULL,
  `Maximum Value` time(6) NOT NULL,
  `Null Value` time(6) DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIMESTAMP` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp NOT NULL,
  `Mid Value` timestamp NOT NULL,
  `Maximum Value` timestamp NOT NULL,
  `Null Value` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `temporal_types_TIMESTAMP1` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(1) NOT NULL,
  `Mid Value` timestamp(1) NOT NULL,
  `Maximum Value` timestamp(1) NOT NULL,
  `Null Value` timestamp(1) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP1` VALUES ('TIMESTAMP(1)','1970-01-01 00:00:01.0','2022-09-29 06:57:39.0','2038-01-19 03:14:07.9',NULL);
...
CREATE TABLE `temporal_types_TIMESTAMP2` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(2) NOT NULL,
  `Mid Value` timestamp(2) NOT NULL,
  `Maximum Value` timestamp(2) NOT NULL,
  `Null Value` timestamp(2) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP2` VALUES ('TIMESTAMP(2)','1970-01-01 00:00:01.00','2022-09-29 06:57:53.00','2038-01-19 03:14:07.99',NULL);
...
CREATE TABLE `temporal_types_TIMESTAMP3` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(3) NOT NULL,
  `Mid Value` timestamp(3) NOT NULL,
  `Maximum Value` timestamp(3) NOT NULL,
  `Null Value` timestamp(3) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP3` VALUES ('TIMESTAMP(3)','1970-01-01 00:00:01.000','2022-09-29 06:58:05.000','2038-01-19 03:14:07.999',NULL);
...
CREATE TABLE `temporal_types_TIMESTAMP4` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(4) NOT NULL,
  `Mid Value` timestamp(4) NOT NULL,
  `Maximum Value` timestamp(4) NOT NULL,
  `Null Value` timestamp(4) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP4` VALUES ('TIMESTAMP(4)','1970-01-01 00:00:01.0000','2022-09-29 06:58:16.0000','2038-01-19 03:14:07.9999',NULL);
...
CREATE TABLE `temporal_types_TIMESTAMP5` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(5) NOT NULL,
  `Mid Value` timestamp(5) NOT NULL,
  `Maximum Value` timestamp(5) NOT NULL,
  `Null Value` timestamp(5) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP5` VALUES ('TIMESTAMP(5)','1970-01-01 00:00:01.00000','2022-09-29 06:58:26.00000','2038-01-19 03:14:07.99999',NULL);
...
CREATE TABLE `temporal_types_TIMESTAMP6` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` timestamp(6) NOT NULL,
  `Mid Value` timestamp(6) NOT NULL,
  `Maximum Value` timestamp(6) NOT NULL,
  `Null Value` timestamp(6) NULL DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `temporal_types_TIMESTAMP6` VALUES ('TIMESTAMP(6)','1970-01-01 00:00:01.000000','2022-09-29 06:58:42.000000','2038-01-19 03:14:07.999999',NULL);
...
CREATE TABLE `temporal_types_YEAR` (
  `Type` varchar(50) NOT NULL,
  `Minimum Value` year NOT NULL,
  `Mid Value` year NOT NULL,
  `Maximum Value` year NOT NULL,
  `Null Value` year DEFAULT NULL,
  PRIMARY KEY (`Type`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
